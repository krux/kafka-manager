...
import scala.language.reflectiveCalls
  ...
  case class VerboseTopicIdentity(topic:String,
                                  ...
                                  size: Option[String] = None,
                                  replicationFactor: Int,
                                  partitionsByBroker: IndexedSeq[BrokerTopicPartitions],
                                  summedTopicOffsets: Long,
                                  preferredReplicasPercentage: Int,
                                  underReplicatedPercentage: Int,
                                  topicBrokers: Int,
                                  brokersSkewPercentage: Int,
                                  brokersSpreadPercentage: Int,
                                  producerRate: String)

  object VerboseTopicIdentity {

    def apply(ti: TopicIdentity): VerboseTopicIdentity = {
      VerboseTopicIdentity(
        ti.topic
        , ti.readVersion
        , ti.partitions
        ...
        , ti.partitionsByBroker
        , ti.summedTopicOffsets
        , ti.preferredReplicasPercentage
        , ti.underReplicatedPercentage
        , ti.topicBrokers
        , ti.brokersSkewPercentage
        , ti.brokersSpreadPercentage
        , ti.producerRate
      )
    }
  }
